...
const e = {
  ...
  , Starback = class {
    ...
    mergeConfig(t) {
      ...
      this.speed = s.speed,
      this.directionY = -1 * s.directionY,
      this.directionX = s.directionX,
      this.starColor = s.starColor,
      this.maxStar = s.maxStar,
      this.slope = s.slope,
      this.starSize = s.starSize,
      this.showFps = s.showFps,
      this.backgroundColor = s.backgroundColor,
      this.distanceX = s.distanceX,
      this.frequency = s.frequency,
      this.randomOpacity = s.randomOpacity,
...
<template>
  <canvas id="canvas" ref="el" style="height: 100%;width: 100%;"></canvas>
</template>
